...
func (q *Queries) CreateSubscription(ctx context.Context, arg CreateSubscriptionParams) (SubscriptionBase, error) {
...
func (q *Queries) GetSubscription(ctx context.Context, id string) (SubscriptionBase, error) {
...
func (q *Queries) ListSubscriptions(ctx context.Context, arg ListSubscriptionsParams) ([]SubscriptionBase, error) {
...
func (q *Queries) UpdateSubscription(ctx context.Context, arg UpdateSubscriptionParams) (SubscriptionBase, error) {
