...
func (q *Queries) DeleteAccountTelegram(ctx context.Context, id string) error {
...
func (q *Queries) GetAccountTelegram(ctx context.Context, id string) (AccountTelegram, error) {
